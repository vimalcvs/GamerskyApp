...
public class PictureRecyclerViewAdapter extends RecyclerView.Adapter {
    ...
    private final ArrayList<PictureDataBean> data;
    ...
    public class PictureViewHolder extends RecyclerView.ViewHolder {
        ...
        private final int cardViewLeftMargin;
        private final int cardViewRightMargin;
        private final int imageViewLeftMargin;
        private final int imageViewRightMargin;
        private final ConstraintLayout msgBar;
