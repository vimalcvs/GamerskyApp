...
public class HomePageFragment extends Fragment {
    ...
    public void init(View view, View headerView) {
        ...
        BannerViewpager vp = headerView.findViewById(R.id.pager);
        vp.setPageMargin(AppUtil.dip2px(requireContext(), 8f));
        ...
        newsRecyclerViewAdapter = new NewsRecyclerViewAdapter(newsList, requireContext(), headerView);
    ...
    public class RefreshHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == 1) {
                ...
                if (!firstRun) {
                    AppUtil.getSnackbar(requireContext(), recyclerView, getString(R.string.updata_successed), true, true).show();
                }
                firstRun = false;
            ...
            if (msg.what == 0) {
                AppUtil.getSnackbar(requireContext(), recyclerView, getString(R.string.updata_failed), true, true).show();
                progressBar.hide();
                refreshLayout.setRefreshing(false);
            }
        }
