...
public class UserFavoritesActivity extends AppCompatActivity {
    ...
    public void init() {
        ...
        ViewPagerFragmentAdapter fragmentAdapter = new ViewPagerFragmentAdapter(getSupportFragmentManager(), fragments, tabTitles, BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT);
